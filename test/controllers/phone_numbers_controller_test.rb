...
class PhoneNumbersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone_number" do
    assert_difference('PhoneNumber.count') do
      post phone_numbers_url, params: { phone_number: { number: @phone_number.number, number_type: @phone_number.number_type, person_id: @phone_number.person_id } }
    end
  ...
  test "should update phone_number" do
    patch phone_number_url(@phone_number), params: { phone_number: { number: @phone_number.number, number_type: @phone_number.number_type, person_id: @phone_number.person_id } }
